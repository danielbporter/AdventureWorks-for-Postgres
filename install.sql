...
CREATE SCHEMA person
  ...
  CREATE TABLE person(
    ...
    name_style "NameStyle" NOT NULL CONSTRAINT "DF_Person_NameStyle" DEFAULT (false),
...
COMMENT ON TABLE person.address IS 'Street address information for customers, employees, and vendors.';
  ...
  COMMENT ON COLUMN person.address.state_province_id IS 'Unique identification number for the state or province. Foreign key to StateProvince table.';
...
COMMENT ON TABLE person.address_type IS 'Types of addresses stored in the Address table.';
  COMMENT ON COLUMN person.address_type.address_type_id IS 'Primary key for AddressType records.';
...
COMMENT ON TABLE person.business_entity_address IS 'Cross-reference table mapping customers, vendors, and employees to their addresses.';
  COMMENT ON COLUMN person.business_entity_address.business_entity_id IS 'Primary key. Foreign key to BusinessEntity.BusinessEntityID.';
  COMMENT ON COLUMN person.business_entity_address.address_id IS 'Primary key. Foreign key to Address.AddressID.';
  COMMENT ON COLUMN person.business_entity_address.address_type_id IS 'Primary key. Foreign key to AddressType.AddressTypeID.';

COMMENT ON TABLE person.business_entity_contact IS 'Cross-reference table mapping stores, vendors, and employees to people';
  COMMENT ON COLUMN person.business_entity_contact.business_entity_id IS 'Primary key. Foreign key to BusinessEntity.BusinessEntityID.';
  COMMENT ON COLUMN person.business_entity_contact.person_id IS 'Primary key. Foreign key to Person.BusinessEntityID.';
  COMMENT ON COLUMN person.business_entity_contact.contact_type_id IS 'Primary key.  Foreign key to ContactType.ContactTypeID.';
...
COMMENT ON TABLE person.email_address IS 'Where to send a person email.';
  COMMENT ON COLUMN person.email_address.business_entity_id IS 'Primary key. Person associated with this email address.  Foreign key to Person.BusinessEntityID';
...
COMMENT ON TABLE person.person_phone IS 'Telephone number and type of a person.';
  COMMENT ON COLUMN person.person_phone.business_entity_id IS 'Business entity identification number. Foreign key to Person.BusinessEntityID.';
  COMMENT ON COLUMN person.person_phone.phone_number IS 'Telephone number identification number.';
  COMMENT ON COLUMN person.person_phone.phone_number_type_id IS 'Kind of phone number. Foreign key to PhoneNumberType.PhoneNumberTypeID.';
